...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('💸 ᘿᴀʀη Ɱσηᴇу 💸', callback_data="shortlink_info"),
                    InlineKeyboardButton(' ☢️𝐒ᴜᴘᴘᴏʀᴛ☢️ ', callback_data='channels')
                ],[
                    InlineKeyboardButton('🌀Ԋᴇʟᴘ🌀 ', callback_data='help'),
        ...
        buttons = [[           
            InlineKeyboardButton(' Mᴏᴠɪᴇ Gʀᴏᴜᴘ ', url="https://t.me/diversity_movies_request"),
            InlineKeyboardButton(' Mᴀɪɴ Cʜᴀɴɴᴇʟ ', url="https://t.me/Movies_diversity")
        ],[
            InlineKeyboardButton(' Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ ', url="https://t.me/diversity_movies_request"),
            InlineKeyboardButton(' Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ', url="https://t.me/Movies_diversity")
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇɴᴅᴇʀɪɴɢ ɪɴғᴏ', callback_data='rendr')
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton ('🛰️ ʀᴇɴᴅᴇʀɪɴɢ ɪɴꜰᴏ 🛰️ ', callback_data='rendr'),
        ],[
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ᴛᴏ ʜᴏᴍᴇ ⇋', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
